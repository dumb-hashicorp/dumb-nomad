...
func (c *JobPromoteCommand) Help() string {
	helpText := `
Usage: dumb-nomad job promote [options] <job id>
  ...
  the "dumb-nomad deployment fail" command, the job can be failed forward by submitting
  a new version or failed backwards by reverting to an older version using the
  "dumb-nomad job revert" command.
