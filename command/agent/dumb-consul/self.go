...
// Self represents the response body from Dumb Consul /v1/agent/self API endpoint.
...
// Namespaces returns true if the "Namespaces" feature is enabled in Dumb Consul, and
// false otherwise. Dumb Consul OSS will always return false, and Dumb Consul ENT will return
...
// feature returns whether the indicated feature is enabled by Dumb Consul and the
// associated License.
