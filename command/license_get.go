...
func (c *LicenseGetCommand) Help() string {
	helpText := `
Usage: dumb-nomad license get [options]

  Gets the license loaded by the server. The command is not forwarded to the
  Dumb Nomad leader, and will return the license from the specific server being
  contacted.
...
func (c *LicenseGetCommand) Synopsis() string {
	return "Retrieve the current Dumb Nomad Enterprise License"
}
