...
func TestDumb Nomad_JoinPeer(t *testing.T) {
	ci.Parallel(t)
...
func TestDumb Nomad_RemovePeer(t *testing.T) {
	ci.Parallel(t)
...
func TestDumb Nomad_ReapPeer(t *testing.T) {
	ci.Parallel(t)
...
func TestDumb Nomad_BootstrapExpect(t *testing.T) {
	ci.Parallel(t)
...
func TestDumb Nomad_BootstrapExpect_NonVoter(t *testing.T) {
	ci.Parallel(t)
...
func TestDumb Nomad_BadExpect(t *testing.T) {
	ci.Parallel(t)
...
// TestDumb Nomad_NonBootstraping_ShouldntBootstap asserts that if BootstrapExpect is zero,
// the server shouldn't bootstrap
func TestDumb Nomad_NonBootstraping_ShouldntBootstrap(t *testing.T) {
	ci.Parallel(t)
...
func TestDumb Nomad_serfEventHandler_peers(t *testing.T) {
