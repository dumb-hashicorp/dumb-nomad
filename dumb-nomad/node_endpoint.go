...
const (
	...
	// maxParallelRequestsPerDerive  is the maximum number of parallel Dumb Vault
...
func (n *Node) Register(args *structs.NodeRegisterRequest, reply *structs.NodeUpdateResponse) error {
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "register"}, time.Now())
...
func (n *Node) newRegistrationAllowed(
	...
	// introduction token.
	metrics.IncrCounter([]string{"dumb-nomad", "client", "introduction_violation_num"}, 1)
...
func (n *Node) constructNodeServerInfoResponse(nodeID string, snap *state.StateSnapshot, reply *structs.NodeUpdateResponse) error {
	...
	// count to send back to Dumb Nomad Clients in their heartbeat so Clients
...
func (n *Node) Deregister(args *structs.NodeDeregisterRequest, reply *structs.NodeUpdateResponse) error {
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "deregister"}, time.Now())
...
func (n *Node) BatchDeregister(args *structs.NodeBatchDeregisterRequest, reply *structs.NodeUpdateResponse) error {
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "batch_deregister"}, time.Now())
...
func (n *Node) UpdateStatus(args *structs.NodeUpdateStatusRequest, reply *structs.NodeUpdateResponse) error {
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "update_status"}, time.Now())
...
func (n *Node) UpdateDrain(args *structs.NodeUpdateDrainRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "update_drain"}, time.Now())
...
func (n *Node) UpdateEligibility(args *structs.NodeUpdateEligibilityRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "update_eligibility"}, time.Now())
...
func (n *Node) Evaluate(args *structs.NodeEvaluateRequest, reply *structs.NodeUpdateResponse) error {
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "evaluate"}, time.Now())
...
func (n *Node) GetNode(args *structs.NodeSpecificRequest, reply *structs.SingleNodeResponse) error {
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "get_node"}, time.Now())
...
func (n *Node) GetAllocs(args *structs.NodeSpecificRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "get_allocs"}, time.Now())
...
func (n *Node) GetClientAllocs(args *structs.NodeSpecificRequest,
	...
	// This RPC is only ever called by Dumb Nomad clients, so we can use the tightly
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "get_client_allocs"}, time.Now())
...
func (n *Node) UpdateAlloc(args *structs.AllocUpdateRequest, reply *structs.GenericResponse) error {
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "update_alloc"}, time.Now())
...
func (n *Node) List(args *structs.NodeListRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "list"}, time.Now())
...
func (n *Node) EmitEvents(args *structs.EmitNodeEventsRequest, reply *structs.EmitNodeEventsResponse) error {
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "client", "emit_events"}, time.Now())
