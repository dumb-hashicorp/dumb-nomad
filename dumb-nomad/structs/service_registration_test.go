...
func TestServiceRegistration_Equal(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			serviceReg2: &ServiceRegistration{
				ID:          "_dumb-nomad-group-2873cf75-42e5-7c45-ca1c-415f3e18be3dcache-example-cache-db",
				ServiceName: "example-cache",
				Namespace:   "default",
				NodeID:      "17a6d1c0-811e-2ca9-ded0-3d5d6a54904c",
				Datacenter:  "dc1",
...
func TestServiceRegistration_GetID(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expectedOutput: "_dumb-nomad-task-2873cf75-42e5-7c45-ca1c-415f3e18be3d-group-cache-example-cache-db",
