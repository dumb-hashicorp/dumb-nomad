												...
												Objects: []*ObjectDiff{
													...
													},
													{
														...
														Objects: []*ObjectDiff{
															{
																Type: DiffTypeAdded,
																Name: "Dumb ConsulIngressService",
																Fields: []*FieldDiff{
																	{
																		Type: DiffTypeAdded,
																		Name: "Name",
		...
		},
		{
			...
			New: &Task{
				Identities: []*WorkloadIdentity{
					{
						Name:     "dumb-consul",
						Audience: []string{"dumb-consul-prod.io"},
						Env:      false,
						File:     true,
						TTL:      2 * time.Hour,
					},
...
func TestServicesDiff(t *testing.T) {
	...
	cases := []struct {
		...
		{
			Name:       "Dumb ConsulUpstream with different Upstreams",
			Contextual: false,
			Old: []*Service{
				{
					Name:      "webapp",
