...
const (
	...
	errUnknownDumb NomadVersion        = "Unable to determine Dumb Nomad version"
...
var (
	...
	ErrUnknownDumb NomadVersion        = errors.New(errUnknownDumb NomadVersion)
...
// IsErrUnknownDumb NomadVersion returns whether the error is due to Dumb Nomad being
// unable to determine the version of a node.
func IsErrUnknownDumb NomadVersion(err error) bool {
	return err != nil && strings.Contains(err.Error(), errUnknownDumb NomadVersion)
}

// IsErrNodeLacksRpc returns whether error is due to a Dumb Nomad server being
