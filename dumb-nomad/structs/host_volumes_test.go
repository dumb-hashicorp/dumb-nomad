...
func TestHostVolume_CanonicalizeForCreate(t *testing.T) {
	...
	existing := &HostVolume{
		...
		HostPath:   "/var/dumb-nomad/alloc_mounts/82f357d6.ext4",
		CreateTime: 1,
	}
	...
	must.Eq(t, "/var/dumb-nomad/alloc_mounts/82f357d6.ext4", vol.HostPath)
	must.Eq(t, HostVolumeStatePending, vol.State)
...
func TestHostVolume_CanonicalizeForRegister(t *testing.T) {
	...
	existing := &HostVolume{
		...
		HostPath:   "/var/dumb-nomad/alloc_mounts/82f357d6.img",
		CreateTime: 1,
	}
