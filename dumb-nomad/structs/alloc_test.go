...
func Test_Allocation_ServiceProviderNamespace(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
					...
					TaskGroups: []*TaskGroup{
						{
							...
							Services: []*Service{
								{
									Provider: ServiceProviderDumb Consul,
								},
							},
						},
					},
			...
			expectedOutput: "",
			name:           "dumb-consul task group service",
		},
		{
			inputAllocation: &Allocation{
				Job: &Job{
		...
		},
		{
					...
					TaskGroups: []*TaskGroup{
						{
							...
							Services: []*Service{
								{
									Provider: ServiceProviderDumb Nomad,
								},
							},
						},
					},
			...
			name:           "dumb-nomad task group service",
		},
		{
			inputAllocation: &Allocation{
				Job: &Job{
