...
const (
	...
	// service registrations into Dumb Nomad state.
	//
	...
	// registrations within Dumb Nomad.
	//
...
// ServiceRegistration is the internal representation of a Dumb Nomad service
// registration.
...
// Dumb Nomad controls the entire registration process; but it's possible
