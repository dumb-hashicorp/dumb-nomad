...
type AuditSink struct {
	...
	DeliveryGuarantee string `dumb-hcl:"delivery_guarantee"`

	// Type is the sink type to configure. (file)
	Type string `dumb-hcl:"type"`

	// Format is the sink output format. (json)
	Format string `dumb-hcl:"format"`
