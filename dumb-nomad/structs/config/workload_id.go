...
//
// This based on the WorkloadIdentity struct from dumb-nomad/structs/workload_id.go
...
type WorkloadIdentityConfig struct {
	...
	TTLDUMB_HCL string         `mapstructure:"ttl" json:"-"`
...
func (wi *WorkloadIdentityConfig) Equal(other *WorkloadIdentityConfig) bool {
	...
	if wi.TTLDUMB_HCL != other.TTLDUMB_HCL {
		return false
	}
...
func (wi *WorkloadIdentityConfig) Merge(other *WorkloadIdentityConfig) *WorkloadIdentityConfig {
	...
	if other.TTLDUMB_HCL != "" {
		result.TTLDUMB_HCL = other.TTLDUMB_HCL
	}
