...
// DUMB_HCLVar returns a the DUMB_HCL of job that requires a DUMB_HCL variables S, N,
// and B to be set. Also returns the content of a vars-file to satisfy
// those variables.
func DUMB_HCLVar() (string, string) {
	return `
variable "S" {
  type = string
}
...
func ServiceRegistrations() []*structs.ServiceRegistration {
	return []*structs.ServiceRegistration{
		{
			ID:          "_dumb-nomad-task-2873cf75-42e5-7c45-ca1c-415f3e18be3d-group-cache-example-cache-db",
		...
		{
			ID:          "_dumb-nomad-task-ca60e901-675a-0ab2-2e57-2f3b05fdc540-group-api-countdash-api-http",
