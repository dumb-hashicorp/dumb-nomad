...
func (e *Eval) GetEval(args *structs.EvalSpecificRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "get_eval"}, time.Now())
...
func (e *Eval) Dequeue(args *structs.EvalDequeueRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "dequeue"}, time.Now())
...
func (e *Eval) Ack(args *structs.EvalAckRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "ack"}, time.Now())
...
func (e *Eval) Nack(args *structs.EvalAckRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "nack"}, time.Now())
...
func (e *Eval) Update(args *structs.EvalUpdateRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "update"}, time.Now())
...
func (e *Eval) Create(args *structs.EvalUpdateRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "create"}, time.Now())
...
func (e *Eval) Reblock(args *structs.EvalUpdateRequest, reply *structs.GenericResponse) error {
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "reblock"}, time.Now())
...
func (e *Eval) Reap(args *structs.EvalReapRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "reap"}, time.Now())
...
func (e *Eval) Delete(
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "delete"}, time.Now())

	// This RPC endpoint is very destructive and alters Dumb Nomad's core state,
	...
	// The eval broker must be disabled otherwise Dumb Nomad's state will likely get
	...
	// possible passed evals are not safe to delete and would make Dumb Nomads state
...
func (e *Eval) List(args *structs.EvalListRequest, reply *structs.EvalListResponse) error {
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "list"}, time.Now())
...
func (e *Eval) Count(args *structs.EvalCountRequest, reply *structs.EvalCountResponse) error {
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "count"}, time.Now())
	namespace := args.RequestNamespace()
...
func (e *Eval) Allocations(args *structs.EvalSpecificRequest,
	...
	defer metrics.MeasureSince([]string{"dumb-nomad", "eval", "allocations"}, time.Now())
