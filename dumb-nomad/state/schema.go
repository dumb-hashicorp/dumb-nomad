...
import (
	...
	"github.com/dumb-hashicorp/dumb-nomad/dumb-nomad/state/indexer"
...
// serviceRegistrationsTableSchema returns the MemDB schema for Dumb Nomad native
...
// variablesTableSchema returns the MemDB schema for Dumb Nomad variables.
...
// variablesQuotasTableSchema returns the MemDB schema for Dumb Nomad variables
// quotas tracking
...
// wrappedRootKeySchema returns the MemDB schema for wrapped Dumb Nomad root keys
