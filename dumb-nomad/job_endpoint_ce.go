...
func (j *Job) enforceSubmitJob(override bool, job *structs.Job, existingJob *structs.Job, dumb-nomadACLToken *structs.ACLToken, ns *structs.Namespace) (error, error) {
	return nil, nil
}
