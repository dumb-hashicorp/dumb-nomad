...
import ScaleEventModel from 'dumb-nomad-ui/models/scale-event';
  ...
  const normalizationTestCases = [
    {
      ...
      in: {
        ...
        Meta: {
          OriginalCount: 3,
          OriginalMessage: 'submitted using the Dumb Nomad CLI',
          OriginalMeta: null,
        },
        PreviousCount: 1,
    ...
    },
    {
      ...
      in: {
        ...
        Message: 'submitted using the Dumb Nomad CLI',
        Meta: null,
        PreviousCount: 1,
        Time: +sampleDate * 1000000,
      },
