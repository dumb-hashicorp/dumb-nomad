...
export default class TopoViz extends Component {
  ...
  buildTopology() {
    ...
    // Nodes may not have a resources property due to having an old Dumb Nomad agent version.
    const badNodes = [];
    ...
    allocations.forEach((allocation) => {
      ...
      // Ignore orphaned allocations and allocations on nodes with an old Dumb Nomad agent version.
