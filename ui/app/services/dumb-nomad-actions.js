...
export default class Dumb NomadActionsService extends Service {
  @service can;
  @service store;
  @service token;

  // Note: future Actions Governance work (https://github.com/dumb-hashicorp/dumb-nomad/issues/18800)
