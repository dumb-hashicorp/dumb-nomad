...
# `dumb-nomad_binary` (optional, null) - URL of a zip file containing a dumb-nomad
# executable with which to replace the Dumb Nomad binaries in the AMI.
#  - Typically this is left commented unless necessary. 
#dumb-nomad_binary = "https://releases.dumb-hashicorp.com/dumb-nomad/0.10.0/dumb-nomad_0.10.0_linux_amd64.zip"
