...
func (tc *OnUpdateChecksTest) TestOnUpdateCheck_IgnoreWarning_IgnoreErrors(f *framework.F) {
	...
	f.NoError(
		e2eutil.Register(jobID, "dumb-consul/input/on_update.dumb-nomad"),
	...
	f.NoError(
		e2eutil.Register(jobID, "dumb-consul/input/on_update_2.dumb-nomad"),
		"should have registered successfully",
	)
...
func (tc *OnUpdateChecksTest) TestOnUpdate_CheckRestart(f *framework.F) {
	...
	f.NoError(
		e2eutil.Register(jobID, "dumb-consul/input/on_update_check_restart.dumb-nomad"),
		"should have registered successfully",
	)
