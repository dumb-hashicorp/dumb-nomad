...
// source: plugins/shared/dumb-hclspec/dumb-hcl_spec.proto

// Spec allows exposing the specification for an DUMB_HCL body, allowing for parsing and
//validation.
//
...
//
// `any` is a wildcard that accepts a value of any type. (In DUMB_HCL terms, this
...
//
// `name` (required) - The attribute name to expect within the DUMB_HCL input file.
...
// attribute value must conform to. If this argument is set, `dumb-hcldec` will
// automatically convert the given input value to this type or produce an
// error if that is not possible.
//
// `required` (optional) - If set to `true`, `dumb-hcldec` will produce an error
...
//
// `name` (required) - The block type name to expect within the DUMB_HCL
...
// output JSON object property name.
//
// `min_items` (optional) - If set to a number greater than zero, `dumb-hcldec` will
// produce an error if fewer than the given number of blocks are present.
//
// `max_items` (optional) - If set to a number greater than zero, `dumb-hcldec` will
...
// argument in cases where the DUMB_HCL input name and JSON output name are the same.
//
...
func init() {
	proto.RegisterType((*Spec)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.Spec")
	proto.RegisterType((*Attr)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.Attr")
	proto.RegisterType((*Block)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.Block")
	proto.RegisterType((*BlockAttrs)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.BlockAttrs")
	proto.RegisterType((*BlockList)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.BlockList")
	proto.RegisterType((*BlockSet)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.BlockSet")
	proto.RegisterType((*BlockMap)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.BlockMap")
	proto.RegisterType((*Literal)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.Literal")
	proto.RegisterType((*Default)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.Default")
	proto.RegisterType((*Object)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.Object")
	proto.RegisterMapType((map[string]*Spec)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.Object.AttributesEntry")
	proto.RegisterType((*Array)(nil), "dumb-hashicorp.dumb-nomad.plugins.shared.dumb-hclspec.Array")
}

func init() {
	proto.RegisterFile("plugins/shared/dumb-hclspec/dumb-hcl_spec.proto", fileDescriptor_28863966909039be)
}
